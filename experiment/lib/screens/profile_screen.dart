    ...
    return Scaffold(
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                _buildLeaderboardItem(2, 'adalahpokoknya', '1450'),
                                _buildLeaderboardItem(3, 'Anda', '1200'),
                                _buildLeaderboardItem(4, 'nimiwisa_laber', '100'),
                                _buildLeaderboardItem(5, 'nimiwisa_laber', '100'),
                                _buildLeaderboardItem(6, 'nimiwisa_laber', '100', isLast: true),
                              ],
                            ),
                          ),
      ...
      bottomNavigationBar: CurvedNavigationBar(
        ...
        items: <Widget>[
          ...
          Icon(Icons.card_giftcard_rounded, size: 28, color: Color(0xFF8B5A3C)),
